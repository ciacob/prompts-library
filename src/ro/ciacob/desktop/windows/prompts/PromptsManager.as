...
public class PromptsManager implements IPromptsManager {
    ...
    public function init(
            ...
            useNativeWindows:Boolean = false):void {
        ...
        if (!_isInitialized) {
            ...
            _useNativeWindows = useNativeWindows;
            _isInitialized = true;
        }
    }
    ...
    public function prompt(
        ...
        var windowStyle:int = _useNativeWindows ?
                (WindowStyle.PROMPT | WindowStyle.NATIVE) :
                WindowStyle.PROMPT;
        _uid = _windowsManager.createWindow(component, windowStyle, true, parentWindowId);
        if (_uid != null) {
            component.uid = _uid;
    ...
    /**
     * Finds the last open modal window that can accept a child modal window. Returns the
     * main window if there are no other modals open.
     */
     ...
     */
    private function _onWindowDestroyed(...ignore):void {
        _uid = null;
